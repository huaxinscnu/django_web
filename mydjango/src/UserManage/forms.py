...
class ChangePasswordForm(forms.Form):
    old_password = forms.CharField(label='原始密码', error_messages={'required':'请输入原始密码'},
        widget=forms.PasswordInput(attrs={'class':'form-control'}))
    new_password1 = forms.CharField(label='新密码', error_messages={'required':'请输入新密码'},
        widget=forms.PasswordInput(attrs={'class':'form-control'}))
    new_password2 = forms.CharField(label='重复输入', error_messages={'required':'请重复新输入密码'},
        widget=forms.PasswordInput(attrs={'class':'form-control'}))
...
class AddUserForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'sex' : forms.RadioSelect(choices=(('男', '男'), ('女', '女')), attrs={'class':'list-inline'}),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['sex'].label = '性 别'
        self.fields['sex'].error_messages = {'required':'请选择性别'}
